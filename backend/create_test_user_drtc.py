#!/usr/bin/env python3
"""Script para crear usuario de prueba en MongoDB - drtc_db"""
...
async def create_test_user():
    """Crear usuario de prueba en drtc_db"""
    ...
    try:
        ...
        if existing:
            print("✅ Usuario de prueba ya existe en drtc_db")
        ...
        print("✅ Usuario de prueba creado exitosamente en drtc_db")
