...
export const routes: Routes = [
  ...
  { 
    ...
    children: [
      ...
      { path: 'resoluciones/nuevo', loadComponent: () => import('./components/resoluciones/resolucion-form.component').then(m => m.ResolucionFormComponent) },
      ...
      { path: 'resoluciones/:id/editar', loadComponent: () => import('./components/resoluciones/resolucion-form.component').then(m => m.ResolucionFormComponent) },
