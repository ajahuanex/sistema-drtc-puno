  ...
  template: `
    <mat-card>
      <mat-card-header>
        ...
        <mat-card-subtitle>Centro de notificaciones</mat-card-subtitle>
      </mat-card-header>
      ...
      <mat-card-content>
        <div class="placeholder-content">
          ...
          <p>El centro de notificaciones estará disponible próximamente.</p>
          <p>Incluirá:</p>
          <ul>
...
export class NotificacionesComponent {
  // Componente placeholder para notificaciones
} 